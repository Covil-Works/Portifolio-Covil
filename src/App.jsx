...
import qn1 from '../img/qn-1.png'
import qn2 from '../img/qn-2.png'
...
const projects = [
  ...
  { name: 'QuantumNet', description: 'Simulador de Redes Quânticas para pesquisa e desenvolvimento publicado no Simpósio Brasileiro de Redes de Computadores.', details: 'Python · Docker', href: 'https://sol.sbc.org.br/index.php/sbrc_estendido/article/view/42593', device: 'desktop', image: null, imageAlt: 'Tela do QuantumNet', carouselImages: [qn1, qn2] },
